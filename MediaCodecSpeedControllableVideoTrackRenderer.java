...
/**
 * Created by skonb on 14/11/04.
 */
@TargetApi(16)
public class MediaCodecSpeedControllableVideoTrackRenderer extends MediaCodecTrackRenderer {

    protected static final String TAG = "MediaCodecSpeedControllableVideoTrackRenderer";
    /**
     * Interface definition for a callback to be notified of {@link com.dank1.supotomo.misc.MediaCodecSpeedControllableVideoTrackRenderer}
     * events.
     */
     ...
     */
    public MediaCodecSpeedControllableVideoTrackRenderer(SampleSource source, int videoScalingMode) {
     ...
     *                                    {@link MediaCodec#setVideoScalingMode(int)}.
     */
    public MediaCodecSpeedControllableVideoTrackRenderer(SampleSource source, DrmSessionManager drmSessionManager,
     ...
     *                                    can attempt to seamlessly join an ongoing playback.
     */
    public MediaCodecSpeedControllableVideoTrackRenderer(SampleSource source,
    ...
    public MediaCodecSpeedControllableVideoTrackRenderer(SampleSource source, DrmSessionManager drmSessionManager,
        ...
        this.allowedJoiningTimeUs = (long) (allowedJoiningTimeMs * 1000 / mCurrentSpeed);
    ...
    protected void onEnabled(long startTimeUs, boolean joining) {
        ...
        if (joining && allowedJoiningTimeUs > 0) {
            joiningDeadlineUs = (long) (SystemClock.elapsedRealtime() * 1000L / mCurrentSpeed) +
...
//        Log.i("test", "processOutputBuffer(position=" + positionUs + "," + "elapsed=" + elapsedRealtimeUs +")");
        if (shouldSkip) {
        ...
        if (earlyUs < -110000 && getState() == TrackRenderer.STATE_ENABLED) {
            // We're more than 30ms late rendering the frame.
//            Log.i("test", "too earlyUs: " + earlyUs);
